...
# array to hold all different probs of ruin wrt p1 and portfolio 1:
PR1 = np.zeros((2,10))
i = 0
...
plt.legend()
fig1.savefig('PR1_re.png')

# array to hold all different probs of ruin wrt p1 and portfolio 2:
PR2 = np.zeros((2,10))
i = 0
for p1 in np.linspace(0.1,1,10):
    invest = 1-p1
...
plt.errorbar(np.linspace(0.1,1,10),PR2[0,:],yerr=100/np.sqrt(1000),label='with coverage')
plt.errorbar(np.linspace(0.1,1,10),PR2[1,:],yerr=100/np.sqrt(1000),label='without coverage')
plt.xlabel('p1, cash holding')
plt.ylabel('Prob of ruin')
plt.legend()
fig2.savefig('PR2_re.png')



# array to hold all different probs of ruin wrt p1 and portfolio 3:
PR3 = np.zeros((2,10))
i = 0
for p1 in np.linspace(0.1,1,10):
    invest = 1-p1

...
# array to hold all different probs of ruin wrt portfolio:
...
for p1 in np.linspace(0.1,1,10):
    ...
    for n in range(trials):
        frac = np.random.normal(0.8,0.4)
        U_array = U(t,kappa,P,N,U_0,initial,t_M,t_mu,c_hat,frac,p1,stock,bond)
...
fig1 = plt.figure()
#plt.plot(np.linspace(0.1,1,10),PR1,label='Portfolio 1 with .4 stdev in frac')
plt.errorbar(np.linspace(0.1,1,10),PR1,yerr=100/np.sqrt(1000),marker='*',label='Portfolio 1 with .4 stdev in frac')
...
for p1 in np.linspace(0.1,1,10):
    ...
    PR2[i] = p
    i += 1
#    print("The probability of ruin approx will be ", p, "percent with portfoli$

#plt.plot(np.linspace(0.1,1,10),PR2,label='Portfolio 2 with .4 stdev in frac')
plt.errorbar(np.linspace(0.1,1,10),PR2,yerr=100/np.sqrt(1000),marker='*',label='Portfolio 2 with .4 stdev in frac')
...
#plt.plot(np.linspace(0.1,1,10),PR3,label='Portfolio 3 with .4 stdev in frac')
plt.errorbar(np.linspace(0.1,1,10),PR3,yerr=100/np.sqrt(1000),marker='*',label='Portfolio 3 with .4 stdev in frac')
plt.legend()
fig1.savefig('PR_lowfrac_pf123.png')
